    ...
    <div className={cn(inputWrapperClassName, wrapperClassName)}>
      ...
      >
        <input
          ...
          className={cn(
            inputClassName,
            "col-start-1 col-end-2 row-start-1 row-end-2 relative z-10 caret-transparent",
            className,
          )}
          style={{ ...props.style }}
          value={inputValue}
        ...
        <motion.div
          ref={caretRef}
          className="bg-[#1F3A4B] col-start-1 col-end-2 row-start-1 row-end-2 self-center z-0 pointer-events-none"
          animate={{
            x: caretX,
